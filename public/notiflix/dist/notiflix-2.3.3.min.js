    ...
    var e, a, n, i, o, s = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation",
        ...
        F = function (a, n, o, s) {
            ...
            if (t.document.getElementById(g.id)) {
                var S, I = t.document.getElementById(g.id),
                    X = t.document.getElementById(x.id);
            ...
            if (e.showOnlyTheLastOne && 0 < A)
                for (var D, T = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + A + "])"), O = 0; O < T.length; O++) D = T[O], null !== D.parentNode && D.parentNode.removeChild(D);
            e = y(!0, e, c)
        },
        ...
        T = function (e, a, n, o) {
            ...
            if (i || P.Loading.Init({}), "string" != typeof e && (e = ""), n) {
                ...
                var x = "";
                if ("standard" === a) x = z(i.svgSize, i.svgColor);
                else if ("hourglass" === a) x = S(i.svgSize, i.svgColor);
                else if ("circle" === a) x = I(i.svgSize, i.svgColor);
                else if ("arrows" === a) x = X(i.svgSize, i.svgColor);
                else if ("dots" === a) x = R(i.svgSize, i.svgColor);
                else if ("pulse" === a) x = L(i.svgSize, i.svgColor);
                else if ("custom" === a && null !== i.customSvgUrl) x = "<img class=\"custom-loading-icon\" width=\"" + i.svgSize + "\" height=\"" + i.svgSize + "\" src=\"" + i.customSvgUrl + "\" alt=\"Notiflix\">";
                else {
            ...
            if ("string" != typeof e && (e = ""), t.document.getElementById(p.ID))
                if (0 < e.length) {
                    ...
                    if (a) a.innerHTML = e;
                        ...
                        var o = parseInt(i.svgSize),
                            s = Math.round(o - o / 4).toString() + "px";
                        n.style.top = s;
        ...
        H = function (e, a, n, s, l) {
            ...
            var p = "number" == typeof o.querySelectorLimit ? o.querySelectorLimit : 200,
                u = c.length >= p ? p : c.length;
            if (e)
                for (var b = 0; b < u; b++) {
                    var y = c[b],
                        k = y.querySelectorAll("[id^=" + x.ID + "]");
                    if (1 > k.length) {
                        var w = "";
                        ...
                        var D = t.getComputedStyle(y).getPropertyValue("min-height"),
                            T = D.replace(/[^\d]/g, ""),
                            O = Math.round(T),
                            H = Math.round(1.5 * (parseInt(B) + v)),
                            j = "";
                    ...
                    V = function (t) {
                        if (t && 0 < t.length)
                            for (var e, n = 0; n < t.length; n++) e = t[n], e && (e.classList.add("remove"), U(e));
