    ...
    var e, i, a, o, n, r = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation",
        ...
        y = function () {
            ...
            for (var o = function (i) {
                    for (var a in i) Object.prototype.hasOwnProperty.call(i, a) && (t[a] = e && "[object Object]" === Object.prototype.toString.call(i[a]) ? y(t[a], i[a]) : i[a])
                }; a < arguments.length; a++) o(arguments[a]);
            return t
        },
        k = function (e) {
        ...
        h = function (e, i) {
            if (!t.document.getElementById("NotiflixQuicksand") && e && "string" == typeof i && "quicksand" === i.toLowerCase()) {
                if (!g("head")) return !1;
        ...
        A = function (a, o, n, r) {
            ...
            if ("object" == typeof o && !Array.isArray(o) || "object" == typeof n && !Array.isArray(n)) {
                var c = {};
                "object" == typeof o ? c = o : "object" == typeof n && (c = n), e = y(!0, e, c)
            }
            var p = e[r.toLocaleLowerCase("en")];
            B++, "function" == typeof o && M++, "string" != typeof a && (a = "Notiflix " + r), e.plainText && (a = k(a)), !e.plainText && a.length > e.messageMaxLength && (e = y(!0, e, {
                closeButton: !0,
            ...
            if (e.useIcon) {
                ...
                C <= v && (z.style.paddingTop = (v - C) / 2 + "px", z.style.paddingBottom = (v - C) / 2 + "px")
            }
            if (t.document.getElementById(x.id)) {
                var S, R = t.document.getElementById(x.id),
                    I = t.document.getElementById(f.id);
                e.backOverlay && (S = t.document.getElementById(d.id));
                var X, W, L = function () {
                        R.classList.add("remove"), e.backOverlay && 0 >= I.childElementCount && S.classList.add("remove"), clearTimeout(X)
                    },
                    A = function () {
                        var i = t.document.getElementById(x.id);
                        i && null !== R.parentNode && R.parentNode.removeChild(R), 0 >= I.childElementCount && null !== I.parentNode && (I.parentNode.removeChild(I), e.backOverlay && null !== S.parentNode && S.parentNode.removeChild(S)), clearTimeout(W)
                    };
                ...
                }("function" == typeof o || e.clickToClose) && R.addEventListener("click", function () {
                    "function" == typeof o && (M--, o()), L();
                    var t = setTimeout(function () {
                        A(), clearTimeout(t)
                    }, e.cssAnimationDuration)
                }), e.closeButton || "function" == typeof o || (X = setTimeout(function () {
                    L()
                }, e.timeout), W = setTimeout(function () {
                    A()
                }, e.timeout + e.cssAnimationDuration))
            }
            if (e.showOnlyTheLastOne && 0 < B)
                for (var E, D = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + B + "])"), T = 0; T < D.length; T++) E = D[T], null !== E.parentNode && E.parentNode.removeChild(E);
            e = y(!0, e, m)
        },
        ...
        D = function (e, i, a, n) {
            if (!g("body")) return !1;
            if (o || P.Loading.Init({}), "string" != typeof e && (e = ""), a) {
                e = e.toString().length > o.messageMaxLength ? k(e).toString().substring(0, o.messageMaxLength) + "..." : k(e).toString();
                var r = parseInt(o.svgSize),
                    l = "";
                if (0 < e.length) {
                    var m = Math.round(r - r / 4).toString() + "px",
                        c = (1.4 * parseInt(o.messageFontSize)).toString() + "px";
                    l = "<p id=\"" + o.messageID + "\" class=\"loading-message\" style=\"color:" + o.messageColor + ";font-size:" + o.messageFontSize + ";height:" + c + "; top:" + m + ";\">" + e + "</p>"
                }
                o.cssAnimation || (o.cssAnimationDuration = 0);
                var f = "";
                if ("standard" === i) f = C(o.svgSize, o.svgColor);
                else if ("hourglass" === i) f = S(o.svgSize, o.svgColor);
                else if ("circle" === i) f = R(o.svgSize, o.svgColor);
                else if ("arrows" === i) f = I(o.svgSize, o.svgColor);
                else if ("dots" === i) f = X(o.svgSize, o.svgColor);
                else if ("pulse" === i) f = W(o.svgSize, o.svgColor);
                else if ("custom" === i && null !== o.customSvgUrl) f = "<img class=\"custom-loading-icon\" width=\"" + o.svgSize + "\" height=\"" + o.svgSize + "\" src=\"" + o.customSvgUrl + "\" alt=\"Notiflix\">";
                else {
                    if ("custom" === i && null == o.customSvgUrl) return d("Notiflix Error", "You have to set a static SVG url to \"customSvgUrl\" option to use Loading Custom."), !1;
                    "notiflix" === i && (f = L(o.svgSize, "#f8f8f8", "#32c682"))
                }
                var x = 0;
                0 < e.length && (x = "-" + Math.round(r - r / 4).toString() + "px");
                var u = "<div style=\"top:" + x + "; width:" + o.svgSize + "; height:" + o.svgSize + ";\" class=\"" + o.className + "-icon" + (0 < e.length ? " with-message" : "") + "\">" + f + "</div>",
                    b = t.document.createElement("div");
                if (b.id = p.ID, b.className = o.className + (o.cssAnimation ? " with-animation" : "") + (o.clickToClose ? " click-to-close" : ""), b.style.zIndex = o.zindex, b.style.background = o.backgroundColor, b.style.animationDuration = o.cssAnimationDuration + "ms", b.style.fontFamily = "\"" + o.fontFamily + "\", " + s, o.rtl && (b.setAttribute("dir", "rtl"), b.classList.add("rtl-on")), b.innerHTML = u + l, !t.document.getElementById(b.id) && (t.document.body.appendChild(b), o.clickToClose)) {
            ...
            } else if (t.document.getElementById(p.ID)) var h = t.document.getElementById(p.ID),
        ...
        T = function (e) {
            if ("string" != typeof e && (e = ""), t.document.getElementById(p.ID))
                if (0 < e.length) {
                    e = e.length > o.messageMaxLength ? k(e).toString().substring(0, o.messageMaxLength) + "..." : k(e).toString();
                    var i = t.document.getElementById(p.ID).getElementsByTagName("p")[0];
                    if (i) i.innerHTML = e;
                    else {
                        var a = t.document.createElement("p");
                        a.id = o.messageID, a.className = "loading-message new", a.style.color = o.messageColor, a.style.fontSize = o.messageFontSize;
                        var n = parseInt(o.svgSize),
                            r = Math.round(n - n / 4).toString() + "px";
                        a.style.top = r;
                        var s = (1.4 * parseInt(o.messageFontSize)).toString() + "px";
                        a.style.height = s, a.innerHTML = e;
                        var l = t.document.getElementById(p.ID);
                        l.appendChild(a);
                        var m = t.document.getElementById(p.ID).getElementsByTagName("div")[0],
                            c = "-" + Math.round(n - n / 4).toString() + "px";
                        m.style.top = c
                    }
                } else d("Notiflix Error", "Where is the new message?")
        },
        O = 0,
        H = function (e, a, o, r, l) {
            if ("string" != typeof a) return d("Notiflix Error", "The selector must be a String."), !1;
            "number" != typeof l && (l = 0);
            var m = t.document.querySelectorAll(a);
            if (0 < m.length) n || P.Block.Init({}), "string" != typeof r && (r = void 0);
            else return d("Notiflix Error", "You called the \"Notiflix.Block...\" function with \"" + a + "\" selector, but there is no such element(s) in the document."), !1;
            n.cssAnimation || (n.cssAnimationDuration = 0);
            var c = "notiflix-block";
            n.className && "string" == typeof n.className && (c = n.className.trim());
            var p = "number" == typeof n.querySelectorLimit ? n.querySelectorLimit : 200,
                u = m.length >= p ? p : m.length;
            if (e)
                for (var b = 0; b < u; b++) {
                    var y = m[b],
                        h = y.querySelectorAll("[id^=" + f.ID + "]");
                    if (1 > h.length) {
                        var w = "";
                        o && ("hourglass" === o ? w = S(n.svgSize, n.svgColor) : "circle" === o ? w = R(n.svgSize, n.svgColor) : "arrows" === o ? w = I(n.svgSize, n.svgColor) : "dots" === o ? w = X(n.svgSize, n.svgColor) : "pulse" === o ? w = W(n.svgSize, n.svgColor) : w = C(n.svgSize, n.svgColor));
                        var v = parseInt(n.svgSize),
                            N = Math.round(v - v / 5).toString() + "px",
                            z = r && 0 < r.length ? "-" + N : 0,
                            L = "<span class=\"" + c + "-icon\" style=\"width:" + n.svgSize + ";height:" + n.svgSize + ";top:" + z + ";\">" + w + "</span>",
                            B = "",
                            M = 0;
                        "string" == typeof r && 0 < r.length && (r = r.length > n.messageMaxLength ? k(r).toString().substring(0, n.messageMaxLength) + "..." : k(r).toString(), M = Math.round(1.4 * parseInt(n.messageFontSize)).toString() + "px", B = "<span style=\"top:" + N + ";height:" + M + ";font-size:" + n.messageFontSize + ";color:" + n.messageColor + ";\" class=\"" + c + "-message\">" + r + "</span>"), O++;
                        var A = t.document.createElement("div");
                        A.id = f.ID + "-" + O, A.className = c + "-wrap" + (n.cssAnimation ? " with-animation" : ""), A.style.position = n.position, A.style.zIndex = n.zindex, A.style.background = n.backgroundColor, A.style.animationDuration = n.cssAnimationDuration + "ms", A.style.fontFamily = "\"" + n.fontFamily + "\", " + s, n.rtl && (A.setAttribute("dir", "rtl"), A.classList.add("rtl-on")), A.innerHTML = L + B;
                        var F = t.getComputedStyle(y).getPropertyValue("position");
                        F = F && "string" == typeof F ? F.toLowerCase() : "relative";
                        var E = t.getComputedStyle(y).getPropertyValue("min-height"),
                            D = E.replace(/[^\d]/g, ""),
                            T = Math.round(D),
                            H = Math.round(1.5 * (parseInt(M) + v)),
                            Q = "";
                        T < H && (Q = "min-height:" + H + "px");
                        var j = "";
                        y.getAttribute("id") ? j = "#" + y.getAttribute("id") : y.classList[0] && (j = "." + y.classList[0]);
                        if (-1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(F)) {
                            if (!g("head")) return !1;
                            var Y = "<style id=\"Style-" + f.ID + "-" + O + "\">" + j + "." + c + "-position{position:relative!important;pointer-events:none;" + Q + ";}</style>",
                                G = t.document.createRange();
                            G.selectNode(t.document.head);
                            var U = G.createContextualFragment(Y);
                            t.document.head.appendChild(U), y.classList.add(c + "-position")
                        }
                        y.appendChild(A)
                    }
                        ...
                        var i = setTimeout(function () {
                            ...
                            o && null !== o.parentNode && o.parentNode.removeChild(o), clearTimeout(i)
                        }, n.cssAnimationDuration)
                    },
                    V = function (t) {
                        if (t && 0 < t.length)
                            for (var e, o = 0; o < t.length; o++) e = t[o], e && (e.classList.add("remove"), q(e));
                    ...
                    $ = setTimeout(function () {
                        for (var t, e = 0; e < u; e++) t = m[e], K(t), h = t.querySelectorAll("[id^=" + f.ID + "]"), V(h);
                        clearTimeout($)
                    }, l)
        },
        P = {
            Notify: {
                Init: function (t) {
                    e = y(!0, l, t), h(e.useGoogleFont, e.fontFamily), b()
                },
                Merge: function (t) {
            ...
            Report: {
                Init: function (t) {
                    i = y(!0, m, t), h(i.useGoogleFont, i.fontFamily), b()
                },
                Merge: function (t) {
                    return i ? void(i = y(!0, i, t)) : (d("Notiflix Error", "You have to initialize the Report module before call Merge function."), !1)
                },
            ...
            Confirm: {
                Init: function (t) {
                    a = y(!0, c, t), h(a.useGoogleFont, a.fontFamily), b()
                },
                Merge: function (t) {
                    return a ? void(a = y(!0, a, t)) : (d("Notiflix Error", "You have to initialize the Confirm module before call Merge function."), !1)
                },
                Show: function (t, e, i, a, o, n) {
                    E(t, e, i, a, o, n)
                }
            },
            Loading: {
                Init: function (t) {
                    o = y(!0, p, t), h(o.useGoogleFont, o.fontFamily), b()
                },
                Merge: function (t) {
                    return o ? void(o = y(!0, o, t)) : (d("Notiflix Error", "You have to initialize the Loading module before call Merge function."), !1)
                },
                Standard: function (t) {
                    D(t, "standard", !0, 0)
                },
            ...
            Block: {
                Init: function (t) {
                    n = y(!0, f, t), h(n.useGoogleFont, n.fontFamily), b()
                },
                Merge: function (t) {
                    return n ? void(n = y(!0, n, t)) : (d("Notiflix Error", "You have to initialize the \"Notiflix.Block\" module before call Merge function."), !1)
                },
